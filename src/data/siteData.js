...
観光・ビジネスともに最適な拠点です。`,
  },
  {
    ...
    station: '東西線  岩葉台駅',
    description: `家族みんなで楽しめる「fureAIショッピングモール」は、休日には人気芸人によるお笑いライブも開催。広々としたフードコートにはバラエティ豊かなメニューが揃い、国内最大級の映画館もあり、お子さまから大人まで大満足。買い物だけでなく、一日中ゆったり過ごせるスポットです。`,
  },
  {
    name: 'うさぴょんランド',
...
小さなお子さまから大人まで楽しめる遊びがいっぱいで、家族みんなの思い出作りにぴったりのスポットです。`,
  },
  {
    ...
    station: '湾岸線  海島駅',
    description: `海島SEA ISLANDでは、色とりどりの魚が泳ぐ巨大水槽と、自慢のカジキマグロショーをお楽しみいただけます。
